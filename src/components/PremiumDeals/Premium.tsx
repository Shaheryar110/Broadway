  ...
  const addProductToCart = () => {
    ...
    filteredArray.forEach((groupName) => {
      options.forEach((options) => {
        if (options.OptionGroupName === groupName.Name) count++;
      });
    });
    ...
    <>
          ...
          <Container sx={style.container}>
            ...
            <Box sx={style.imgBox}>
              <Image
                ...
                width={240}
                height={228}
                className="permiumImage"
                style={{
                  borderTopLeftRadius: "30px",
                  borderTopRightRadius: "30px",
                  // marginBottom:{md:'0px',xs:"22px"}
                }}
              />
            </Box>
          </Container>
      ...
      <Box sx={style.large} className="ppLarge">
        <Grid container sx={{ position: "relative" }}>
          ...
          <Grid item lg={3} sx={{ backgroundColor: "#EDDAC5", width: "100%" }}>
            <Box
              sx={[
                style.imgBox,
                {
          ...
          <Grid item lg={9} p={"16px"} position={"relative"} width={"100%"}>
            <Box
              sx={{
                width: "100%",
                height: "500px",
...
const style = {
  ...
  containerText: {
    maxWidth: { lg: "900px", sm: "700px", xs: "350px" },
  },
  container1: {
    maxWidth: { lg: "2830px" },
    position: "absolute",
  ...
  section: {
    marginTop: { lg: "5rem", md: "3rem", xs: "46px" },
  },
  badge: {
    position: "absolute",
    top: "0px",
