      ...
      <Box sx={style.main}>
        <Container sx={style.container}>
          <Typography sx={style.heading} className={poppins.className}>
            Become a Franchisee for Broadway
          </Typography>
          <Box sx={style.frenchiseBox} className="frenchise">
            ...
            <label className={`input-b ${poppins.className}`}>
              ...
              >
                ...
                <MenuItem value={30}>Relative</MenuItem>
                <MenuItem value={40}>Restaraunt</MenuItem>
                <MenuItem value={50}>website</MenuItem>
              </Select>
            </label>
            <label className={`input-b ${poppins.className}`}>
              <span>
              ...
              >
                <MenuItem value={10000000}>PRK 25 million</MenuItem>
                <MenuItem value={30000000}>PRK 30 million</MenuItem>
                <MenuItem value={35000000}>PRK 35 million</MenuItem>
                <MenuItem value={40000000}>PRK 40 million</MenuItem>
                <MenuItem value={45000000}>PRK 45 million</MenuItem>
                <MenuItem value={50000000}>PRK 50 million</MenuItem>
              </Select>
            </label>
            <label className={`input-b ${poppins.className}`}>
